...
const ListViewVideos = ({ rowsPerPage, page }) => {
  ...
  const fetchPost = async () => {
    try {
      let res = await axios.get(`${process.env.REACT_APP_URL}/youtube/videos`);
  ...
  const handleDelete = async (id) => {
    await axios
      .delete(`${process.env.REACT_APP_URL}/deleteVideos/${id}`, {headers: {
