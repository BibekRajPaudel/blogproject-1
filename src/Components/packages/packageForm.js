...
const PackageForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (
      ...
      if (image0.length > 0) {
        for (let i = 0; i < image0.length; i++) {
          formData.append("image0", image0[i]);
        }
      }
  ...
  const onfileChange0 = () => {
    formik.setFieldValue("image0", selectedFile0);
  };
  ...
  const {
    ...
    onDrop: (acceptedFiles) => {
      ...
      formik.setFieldValue("image0", acceptedFiles);
    },
  });
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <div className="w-full mt-5 px-4">
        <h1 className="text-[16px] font-[700] mb-3">थप ट्याग</h1>
        <FormInput
          name="allTags"
          formik={formik}
          //placeholder="शीर्षक..."
      ...
      <div className="w-full mt-5 px-4">
        ...
        <div className="text-[red]">
          {formik.touched["image0"] && formik.errors["image0"]
      ...
      <div className="w-full mt-5 px-4">
        ...
        <FormTextAreaField name="description6" formik={formik} type="text" />
      </div>
