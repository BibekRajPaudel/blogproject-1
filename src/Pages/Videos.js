...
import PostAd from "../Components/packages/adAdd";
import ListviewAd from "../Components/ViewComponent/ListviewAd";
import PostVideos from "../Components/packages/adVideos";
import ListViewVideos from "../Components/ViewComponent/ListViewVideos";
        ...
        >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              ...
              {leedModal && <PostVideos setLeadmodal={setLeadmodal} />}
            </div>
          ...
          <div className="w-full mt-5 bg-white rounded border-2 border-[#e7e7e7]">
            ...
            <ListViewVideos rowsPerPage={rowsPerPage} page={page} />
          </div>
        </div>
      </div>
    </>
